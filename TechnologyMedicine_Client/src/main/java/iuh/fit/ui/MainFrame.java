...
public class MainFrame extends JFrame {
    ...
    private void showThuocPanel(ActionEvent e) {
        ...
        ThuocPanel thuocPanel = new ThuocPanel(); // ✅ Dùng class bạn đã tạo
        contentPanel.add(thuocPanel, BorderLayout.CENTER); // Thêm vào khu vực nội dung
    ...
    private void showKhachHangPanel(ActionEvent e) {
        ...
        KhachHangPanel khachHangPanel = new KhachHangPanel(); // ✅ Dùng class bạn đã tạo
        contentPanel.add(khachHangPanel, BorderLayout.CENTER); // Thêm vào khu vực nội dung
    ...
    private void showNhaCungCapPanel(ActionEvent e) {
        ...
        NhaCungCapPanel nccPanel = new NhaCungCapPanel(); // ✅ Dùng class bạn đã tạo
        contentPanel.add(nccPanel, BorderLayout.CENTER); // Thêm vào khu vực nội dung
