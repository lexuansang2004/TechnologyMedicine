...
public class LoginFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        usernameField = new JTextField("xuansang", 20);
        passwordField = new JPasswordField("$2b$12$dwnbvqL2ZIT",20);
...
//    }
private void handleLogin(ActionEvent e) {
    // Bỏ qua kiểm tra username/password luôn
    Object dummyUser = null;
    MainFrame mainFrame = new MainFrame(dummyUser);
    mainFrame.setVisible(true);
    dispose();
}
}